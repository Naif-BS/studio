...
export default function TicketFilters({ filters, onFilterChange, showSearch = true }: TicketFiltersProps) {
  ...
  return (
    <div className={cn(
      "mb-3 p-3 rounded-lg border bg-card text-card-foreground shadow-lg" 
      // Removed glassy classes and animation, as it's a custom wrapper, not a Card component instance
    )}>
