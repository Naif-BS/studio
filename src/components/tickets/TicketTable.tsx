    ...
    return (
      <div className="rounded-md border">
        <Table>
          <TableHeader>
            <TableRow>
              {['Serial Number', 'Status', 'Description', 'Received', 'Actions'].map((header) => (
        ...
        <TableBody>
          {tickets.map((ticket) => (
            ...
            >
              ...
              <TableCell className="truncate max-w-md" title={ticket.description}>{ticket.description}</TableCell>
